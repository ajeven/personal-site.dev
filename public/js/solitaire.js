...
function solitaireGame(oUniqueName,oWorkspace,oDeck,oWastePile,oFoundation,oTableau,oCardWord,oCardNames,oSuits,youWin,oDeal,oOptions,
	...
	this.cardStacks = [];
	this.cardStacks[0] = new cardStack(0,0,true,oDeck?oDeck:' ');
	this.cardStacks[1] = new cardStack(1,1,true,oWastePile?oWastePile:' ');
	for( var i = 2; i < 6; i++ ) {
		this.cardStacks[i] = new cardStack(2,i,true,oFoundation?oFoundation:' ');
	}
	for( var i = 6; i < 13; i++ ) {
